...
type User struct {
	...
	Password        string `gorm:"type:varchar(100); not null" json:"-" redis:"-"`                                                      //密码(返回json时，不包括密码)
	Avatar          string `gorm:"type:varchar(100); default:'/image/avatar.jpg'" json:"avatar" redis:"avatar"`                         // 用户头像
	BackgroundImage string `gorm:"type:varchar(100); default:'/image/background.jpg'" json:"background_image" redis:"background_image"` // 用户个人页顶部大图
	...
	Signature       string `gorm:"type:varchar(100) ;default:'默认个人签名!'" json:"signature,omitempty"  redis:"signature"`                  // 个人简介
