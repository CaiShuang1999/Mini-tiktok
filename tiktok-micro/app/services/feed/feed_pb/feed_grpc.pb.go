...
func (c *feedServiceClient) FeedList(ctx context.Context, in *FeedRequest, opts ...grpc.CallOption) (*FeedResponse, error) {
	out := new(FeedResponse)
	err := c.cc.Invoke(ctx, "/feed_pb.FeedService/FeedList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FeedServiceServer interface {
	FeedList(context.Context, *FeedRequest) (*FeedResponse, error)
...
func (UnimplementedFeedServiceServer) FeedList(context.Context, *FeedRequest) (*FeedResponse, error) {
...
func _FeedService_FeedList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/feed_pb.FeedService/FeedList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeedServiceServer).FeedList(ctx, req.(*FeedRequest))
	}
...
var FeedService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "feed_pb.FeedService",
